...
const Dish = () => {
  ...
  return (
    <div className="bg-white border border-grayborder
     rounded-md lg:p-4 md:p-3 p-2 max-w-[300px] lg:space-y-5 md:space-y-4 sm:space-y-3 space-y-2 "
      >
      ...
      <div className=" flex justify-end">
        <button className="bg-lightgreen cursor-pointer text-white lg:px-6 md:px-4 px-2 py-1 rounded-lg font-bold lg:text-lg md:text-base sm:text-sm text-xs" onClick={()=>router.push('/main-page/nutrition-page/meal/mealDetail')}>
          Xem chi tiết
        </button>
      </div>
    </div>
