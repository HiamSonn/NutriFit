        ...
        <div className="lg:space-y-10 md:space-y-8 sm:space-y-6 space-y-4">
          <div className="grid lg:grid-cols-2 md:grid:cols-2 grid-cols-1 lg:gap-20 md:gap-12 sm:gap-10 gap-8 min-h-[100px] mt-10 ">
            <div className="col-span-1 space-y-2 border border-grayborder px-4 py-2 rounded-md">
              ...
              <h1 className="font-bold lg:text-lg md:text-xs sm:text-xs text-xs">Bữa sáng</h1>
            ...
            <div className="col-span-1  px-4 py-2 rounded-md">
              ...
              <AccountCircleIcon sx={{
                ...
                <span className="flex items-center lg:text-xl md:text-lg sm:text-base text-sm">Nguyễn Văn A</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-grayborder px-4 py-2 rounded-md lg:w-[60%]">
            <h1 className="text-darkgreen font-bold lg:text-2xl md:text-lg sm:text-base text-sm">Bình luận</h1>
            ...
            <div className="py-3 flex  rounded-md justify-between pl-2 space-x-2">
              ...
              <div className="border border-grayborder p-3 rounded-md">
                <h1 className=" font-bold lg:text-lg md:text-base text-sm ">Trịnh Trần Phương Tuấn</h1>
