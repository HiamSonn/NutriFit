    ...
    <div className="min-h-screen bg-white p-4 px-20">
      ...
      <header className="bg-blue-50 rounded-lg p-4 mb-4 mt-4">
        ...
        <div className="flex justify-between text-gray-600 w-2/3 px-20">
          ...
          <div>
            ...
            <span className="ml-2 text-teal-600 font-semibold">10 phút</span>
          </div>
          <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
        <div className="flex justify-between items-center px-20">
          ...
          <button className="px-12 py-2 font-bold text-teal-500 border-2 border-teal-500 bg-teal-50 rounded-lg hover:bg-teal-100 transition-colors">
            Cài đặt
          </button>
        </div>
      </div>
